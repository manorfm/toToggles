 ...
 * code as the resolved context value. Matching is exact and case-sensitive — callers should normalize case
...
class CountryStrategy : ActivationStrategy {
    ...
    override fun evaluate(rule: ActivationRule, contextValue: String?): Boolean {
        ...
        logger.debug("Country strategy evaluated: result={}", result)
        return result
    }
